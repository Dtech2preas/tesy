        ...
        window.runEligibilityCheck = function() {{
            ...
            setTimeout(() => {{
                ...
                resultBox.innerHTML = `
                    ...
                    <button class="btn btn-outline" style="margin-left:10px; border-color:transparent;" onclick="hasLeftPage = false; document.getElementById('check-instruction').style.display='block'; document.getElementById('eligibility-result').classList.add('hidden');">Re-calculate</button>
